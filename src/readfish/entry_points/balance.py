...
from readfish.plugins.seqtagger import Caller

_help = "Run barcode balancing targeted sequencing"
...
class Analysis:
    ...
    def __init__(
        ...
        # )
        self.caller = Caller(run_information=self.run_information, sample_rate=self.sample_rate)
    ...
    def run(self):
        ...
        while self.client.is_sequencing:
            ...
            chunks = self.client.get_read_chunks(self.client.channel_count, last=False)

            calls = self.caller.call(
